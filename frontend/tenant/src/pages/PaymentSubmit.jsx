...
export default function PaymentSubmit() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (mode === 'UPI') {
      if (refId) fd.append('upi_reference_id', refId);
  ...
  return (
    <>
      ...
      <div className="card">
        ...
        <p style={{fontSize: '2.25rem', fontWeight: '700', color: 'var(--primary)', margin: '0 0 0.25rem'}}>₹{Number(tenant.monthly_rent || 0).toLocaleString('en-IN')}</p>
      ...
      <div className="card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {mode === 'UPI' && (
            <>
              <div className="form-group">
                <label htmlFor="pay-ref">UPI Reference ID</label>
                <input id="pay-ref" type="text" value={refId} onChange={e => setRefId(e.target.value)} placeholder="e.g. 312578xxxxxx (from UPI app)" />
              </div>
              <div className="form-group">
