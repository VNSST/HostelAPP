  ...
  return (
    <div>
      ...
      {summary && summary.total_rooms === 0 && (
        <div style={{background: 'rgba(239, 68, 68, 0.1)', border: '1px solid #EF4444', borderRadius: '12px', padding: '1rem 1.5rem', marginBottom: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
          <div>
            <h3 style={{margin: '0 0 0.5rem', color: '#B91C1C'}}>Action Required: Add Rooms</h3>
            <p style={{margin: 0, color: 'var(--text-main)', fontSize: '0.9rem'}}>Tenants cannot register until you define your hostel's rooms and rent amounts.</p>
          </div>
          <Link to="/admin/rooms" className="button" style={{textDecoration: 'none'}}>Go to Rooms</Link>
        </div>
      )}
